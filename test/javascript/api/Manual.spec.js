  ...
  describe('Manual', function() {
    describe('test', function() {
      ...
      res =  await searchApi.search(search_request);
			...
			search_request = new Manticoresearch.KnnSearchRequestByVector(
          "movies",
          "type_vector",
          [1.5,-1.0,1.6],
          5
      ...
      search_request = new Manticoresearch.KnnSearchRequestByDocId(
          "movies",
          "type_vector",
          1,
      		5
      ...
      search_request.filter = {"bool": {"must": {"equals": {"id": 3} } } }
      res = await searchApi.search(search_request)
