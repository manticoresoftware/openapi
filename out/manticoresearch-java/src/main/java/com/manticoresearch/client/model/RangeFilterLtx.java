...
@JsonDeserialize(using = RangeFilterLtx.RangeFilterLtxDeserializer.class)
@JsonSerialize(using = RangeFilterLtx.RangeFilterLtxSerializer.class)
public class RangeFilterLtx extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(RangeFilterLtx.class.getName());

    public static class RangeFilterLtxSerializer extends StdSerializer<RangeFilterLtx> {
        public RangeFilterLtxSerializer(Class<RangeFilterLtx> t) {
            super(t);
        }

        public RangeFilterLtxSerializer() {
            this(null);
        }

        @Override
        public void serialize(RangeFilterLtx value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class RangeFilterLtxDeserializer extends StdDeserializer<RangeFilterLtx> {
        public RangeFilterLtxDeserializer() {
            this(RangeFilterLtx.class);
        }

        public RangeFilterLtxDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public RangeFilterLtx deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                RangeFilterLtx ret = new RangeFilterLtx();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for RangeFilterLtx: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public RangeFilterLtx getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "RangeFilterLtx cannot be null");
        }
    }
    ...
    public RangeFilterLtx() {
        super("oneOf", Boolean.FALSE);
    }

    public RangeFilterLtx(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RangeFilterLtx(Long o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RangeFilterLtx(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(RangeFilterLtx.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return RangeFilterLtx.schemas;
    }
