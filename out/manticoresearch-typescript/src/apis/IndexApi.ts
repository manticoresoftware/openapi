...
export interface PartialReplaceRequest {
    index: string;
    id: number;
...
export class IndexApi extends runtime.BaseAPI {
     ...
     */
    async partialReplaceRaw(requestParameters: PartialReplaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateResponse>> {
        if (requestParameters.index === null || requestParameters.index === undefined) {
            throw new runtime.RequiredError('index','Required parameter requestParameters.index was null or undefined when calling partialReplace.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling partialReplace.');
        }

        if (requestParameters.replaceDocumentRequest === null || requestParameters.replaceDocumentRequest === undefined) {
            throw new runtime.RequiredError('replaceDocumentRequest','Required parameter requestParameters.replaceDocumentRequest was null or undefined when calling partialReplace.');
        }
     ...
     * Partially replaces a document in an index
     */
    async partialReplace(index: string, id: number, replaceDocumentRequest: ReplaceDocumentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateResponse> {
        const response = await this.partialReplaceRaw({ index: index, id: id, replaceDocumentRequest: replaceDocumentRequest }, initOverrides);
        return await response.value();
    }
