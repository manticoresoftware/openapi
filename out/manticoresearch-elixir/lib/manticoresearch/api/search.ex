...
defmodule Manticoresearch.Api.Search do
  ...
  {:error, info} on failure
  """
  @spec search(Tesla.Env.client, Manticoresearch.Model.UNKNOWN_BASE_TYPE.t, keyword()) :: {:ok, Manticoresearch.Model.SearchResponse.t} | {:ok, Manticoresearch.Model.ErrorResponse.t} | {:error, Tesla.Env.t}
  def search(connection, u_nknownbasetype, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/search")
