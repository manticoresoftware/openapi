...
namespace ManticoreSearch.Model
{
    ...
    public partial class AggDateHistogram : IValidatableObject
    {
        ...
        public AggDateHistogram(string  = default(string), int  = default(int), int  = default(int), bool  = default(bool))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AggDateHistogram and cannot be null");
            }
            this.Field = ;
            this.Interval = ;
            this.Offset = ;
