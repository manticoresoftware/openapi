...
namespace ManticoreSearch.Model
{
    ...
    public partial class Join : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Join" /> class.
        /// </summary>
        /// <param name="">Type of the join operation (required).</param>
        /// <param name="">List of objects defining joined tables (required).</param>
        /// <param name="">.</param>
        /// <param name="">Basic table of the join operation (required).</param>
