...
namespace ManticoreSearch.Model
{
    ...
    public partial class AutocompleteRequest : IValidatableObject
    {
        ...
        public AutocompleteRequest(string  = default(string), string  = default(string), Object  = default(Object))
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new ArgumentNullException(" is a required property for AutocompleteRequest and cannot be null");
            }
            this.Table = ;
            // to ensure "" is required (not null)
            if ( == null)
