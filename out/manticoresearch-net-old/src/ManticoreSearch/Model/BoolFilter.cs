...
namespace ManticoreSearch.Model
{
    ...
    public partial class BoolFilter : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="">Query clauses that must match for the document to be included.</param>
        /// <param name="">Query clauses that must not match for the document to be included.</param>
        /// <param name="">Query clauses that should be matched, but are not required.</param>
