...
namespace ManticoreSearch.Model
{
    ...
    /// </summary>
    [DataContract(Name = "knnSearchRequestByVector")]
    public partial class KnnSearchRequestByVector : IEquatable<KnnSearchRequestByVector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KnnSearchRequestByVector" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KnnSearchRequestByVector() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KnnSearchRequestByVector" /> class.
        /// </summary>
        ...
        public KnnSearchRequestByVector(string index = "", string field = "", List<decimal> queryVector = default(List<decimal>), int k = default(int), Object fulltextFilter = default(Object), Object attrFilter = default(Object), int limit = default(int), int offset = default(int), int maxMatches = default(int), List<Object> sort = default(List<Object>), Dictionary<string, Aggregation> aggs = default(Dictionary<string, Aggregation>), Dictionary<string, string> expressions = default(Dictionary<string, string>), Highlight highlight = default(Highlight), Object source = default(Object), Dictionary<string, Object> options = default(Dictionary<string, Object>), bool profile = default(bool), bool trackScores = default(bool))
        {
            // to ensure "index" is required (not null)
            if (index == null)
            {
                throw new ArgumentNullException("index is a required property for KnnSearchRequestByVector and cannot be null");
            }
            this.Index = index;
            // to ensure "field" is required (not null)
            if (field == null)
            {
                throw new ArgumentNullException("field is a required property for KnnSearchRequestByVector and cannot be null");
            }
            this.Field = field;
            // to ensure "queryVector" is required (not null)
            if (queryVector == null)
            {
                throw new ArgumentNullException("queryVector is a required property for KnnSearchRequestByVector and cannot be null");
            }
        ...
        {
            return this.Equals(input as KnnSearchRequestByVector);
        }

        /// <summary>
        /// Returns true if KnnSearchRequestByVector instances are equal
        /// </summary>
        /// <param name="input">Instance of KnnSearchRequestByVector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KnnSearchRequestByVector input)
        {
            if (input == null)
            {
                return false;
