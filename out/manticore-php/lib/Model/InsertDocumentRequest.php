...
class InsertDocumentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'insertDocumentRequest';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InsertDocumentRequest., must be bigger than or equal to 1.');
        }
