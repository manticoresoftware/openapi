...
class SearchApi
{
    ...
    /**
     * Operation percolateWithHttpInfo
     *
     * Perform reverse search on a percolate index
     *
     * @param  string $index Name of the percolate index (required)
    ...
    /**
     * Operation percolateAsyncWithHttpInfo
     *
     * Perform reverse search on a percolate index
     *
     * @param  string $index Name of the percolate index (required)
    ...
    protected function percolateRequest($index, $percolate_request)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($percolate_request)) {
            $_tempBody = $percolate_request;
        }
