...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new ManticoreSearchApi.UpdateDocumentRequest();
  });
  ...
  describe('UpdateDocumentRequest', function() {
    it('should create an instance of UpdateDocumentRequest', function() {
      ...
      //var instance = new ManticoreSearchApi.UpdateDocumentRequest();
      //expect(instance).to.be.a(ManticoreSearchApi.UpdateDocumentRequest);
    });
