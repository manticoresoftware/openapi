...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManticoreSearchApi.PercolateRequestQuery();
  });
  ...
  describe('PercolateRequestQuery', function() {
    it('should create an instance of PercolateRequestQuery', function() {
      ...
      //var instane = new ManticoreSearchApi.PercolateRequestQuery();
      //expect(instance).to.be.a(ManticoreSearchApi.PercolateRequestQuery);
    });
