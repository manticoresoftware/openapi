...
**Match** | Pointer to **interface{}** | Filter object defining a match keyword | [optional] 
...
**Range** | Pointer to **map[string]interface{}** | Filter to match a given range of attribute values. | [optional] 
