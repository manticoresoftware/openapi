...
#
package WWW::OpenAPIClient::Object::SearchRequest;
...
__PACKAGE__->class_documentation({description => 'Payload for search operation',
                                  class => 'SearchRequest',
                                  required => [], # TODO
}                                 );
