...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.BoolFilterBool();
  });
  ...
  describe('BoolFilterBool', function() {
    it('should create an instance of BoolFilterBool', function() {
      // uncomment below and update the code to test BoolFilterBool
      //var instance = new Manticoresearch.BoolFilterBool();
      //expect(instance).to.be.a(Manticoresearch.BoolFilterBool);
    });
