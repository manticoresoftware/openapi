...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.GeoFilterGeoDistance();
  });
  ...
  describe('GeoFilterGeoDistance', function() {
    it('should create an instance of GeoFilterGeoDistance', function() {
      // uncomment below and update the code to test GeoFilterGeoDistance
      //var instance = new Manticoresearch.GeoFilterGeoDistance();
      //expect(instance).to.be.a(Manticoresearch.GeoFilterGeoDistance);
    });
