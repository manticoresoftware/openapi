...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.RangeFilterRangeValue();
  });
  ...
  describe('RangeFilterRangeValue', function() {
    it('should create an instance of RangeFilterRangeValue', function() {
      // uncomment below and update the code to test RangeFilterRangeValue
      //var instance = new Manticoresearch.RangeFilterRangeValue();
      //expect(instance).to.be.a(Manticoresearch.RangeFilterRangeValue);
    });
