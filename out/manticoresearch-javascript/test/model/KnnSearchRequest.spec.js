...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.KnnSearchRequest();
  });
  ...
  describe('KnnSearchRequest', function() {
    it('should create an instance of KnnSearchRequest', function() {
      // uncomment below and update the code to test KnnSearchRequest
      //var instance = new Manticoresearch.KnnSearchRequest();
      //expect(instance).to.be.a(Manticoresearch.KnnSearchRequest);
    });
