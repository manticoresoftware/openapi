...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new Manticoresearch.KnnSearchRequestByVector();
  });
  ...
  describe('KnnSearchRequestByVector', function() {
    it('should create an instance of KnnSearchRequestByVector', function() {
      // uncomment below and update the code to test KnnSearchRequestByVector
      //var instance = new Manticoresearch.KnnSearchRequestByVector();
      //expect(instance).to.be.a(Manticoresearch.KnnSearchRequestByVector);
    });
