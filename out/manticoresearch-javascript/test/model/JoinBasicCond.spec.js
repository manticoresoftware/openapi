...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.JoinBasicCond();
  });
  ...
  describe('JoinBasicCond', function() {
    it('should create an instance of JoinBasicCond', function() {
      // uncomment below and update the code to test JoinBasicCond
      //var instance = new Manticoresearch.JoinBasicCond();
      //expect(instance).to.be.a(Manticoresearch.JoinBasicCond);
    });
