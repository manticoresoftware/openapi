...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.KnnSearchParameters();
  });
  ...
  describe('KnnSearchParameters', function() {
    it('should create an instance of KnnSearchParameters', function() {
      // uncomment below and update the code to test KnnSearchParameters
      //var instance = new Manticoresearch.KnnSearchParameters();
      //expect(instance).to.be.a(Manticoresearch.KnnSearchParameters);
    });
