...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.SearchRequestParameters();
  });
  ...
  describe('SearchRequestParameters', function() {
    it('should create an instance of SearchRequestParameters', function() {
      // uncomment below and update the code to test SearchRequestParameters
      //var instance = new Manticoresearch.SearchRequestParameters();
      //expect(instance).to.be.a(Manticoresearch.SearchRequestParameters);
    });
