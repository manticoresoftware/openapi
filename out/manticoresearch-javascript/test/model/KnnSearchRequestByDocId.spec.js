...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new Manticoresearch.KnnSearchRequestByDocId();
  });
  ...
  describe('KnnSearchRequestByDocId', function() {
    it('should create an instance of KnnSearchRequestByDocId', function() {
      // uncomment below and update the code to test KnnSearchRequestByDocId
      //var instance = new Manticoresearch.KnnSearchRequestByDocId();
      //expect(instance).to.be.a(Manticoresearch.KnnSearchRequestByDocId);
    });
