...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.AttrFilter();
  });
  ...
  describe('AttrFilter', function() {
    it('should create an instance of AttrFilter', function() {
      // uncomment below and update the code to test AttrFilter
      //var instance = new Manticoresearch.AttrFilter();
      //expect(instance).to.be.a(Manticoresearch.AttrFilter);
    });
