...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.KnnSearchRequestAllOfKnn();
  });
  ...
  describe('KnnSearchRequestAllOfKnn', function() {
    it('should create an instance of KnnSearchRequestAllOfKnn', function() {
      // uncomment below and update the code to test KnnSearchRequestAllOfKnn
      //var instance = new Manticoresearch.KnnSearchRequestAllOfKnn();
      //expect(instance).to.be.a(Manticoresearch.KnnSearchRequestAllOfKnn);
    });
