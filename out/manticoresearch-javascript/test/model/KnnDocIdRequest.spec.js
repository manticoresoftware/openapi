...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Manticoresearch.KnnDocIdRequest();
  });
  ...
  describe('KnnDocIdRequest', function() {
    it('should create an instance of KnnDocIdRequest', function() {
      // uncomment below and update the code to test KnnDocIdRequest
      //var instance = new Manticoresearch.KnnDocIdRequest();
      //expect(instance).to.be.a(Manticoresearch.KnnDocIdRequest);
    });
