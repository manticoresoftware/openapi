 ...
 * @version 4.0.0
 */
class AggregationCompositeSourcesInnerValueTerms {
    /**
    ...
    constructor() { 
        ...
        AggregationCompositeSourcesInnerValueTerms.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AggregationCompositeSourcesInnerValueTerms();
    ...
    /**
     * Validates the JSON data with respect to <code>AggregationCompositeSourcesInnerValueTerms</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AggregationCompositeSourcesInnerValueTerms</code>.
     */
 ...
 * @member {String} field
 */
AggregationCompositeSourcesInnerValueTerms.prototype['field'] = undefined;
...
export default AggregationCompositeSourcesInnerValueTerms;
