...
import HighlightAllOfFields from './HighlightAllOfFields';
...
class Highlight {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fields')) {
                obj['fields'] = HighlightAllOfFields.constructFromObject(data['fields']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['fields']) { // data not null
          HighlightAllOfFields.validateJSON(data['fields']);
        }
...
/**
 * @member {module:model/HighlightAllOfFields} fields
 */
