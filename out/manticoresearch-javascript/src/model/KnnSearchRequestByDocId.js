...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Manticoresearch.KnnSearchRequestByDocId = factory(root.Manticoresearch.ApiClient, root.Manticoresearch.Aggregation, root.Manticoresearch.Highlight);
  }
  ...
  /**
   * The KnnSearchRequestByDocId model module.
   * @module model/KnnSearchRequestByDocId
   * @version 4.1.0
   */

  /**
   * Constructs a new <code>KnnSearchRequestByDocId</code>.
   * Request object for knn search operation
   * @alias module:model/KnnSearchRequestByDocId
   * @class
   * @param index {String} 
   * @param field {String} 
   * @param docId {Number} 
   * @param k {Number} 
   */
  var exports = function(index, field, docId, k) {
    var _this = this;
  ...
  /**
   * Constructs a <code>KnnSearchRequestByDocId</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KnnSearchRequestByDocId} obj Optional instance to populate.
   * @return {module:model/KnnSearchRequestByDocId} The populated <code>KnnSearchRequestByDocId</code> instance.
   */
